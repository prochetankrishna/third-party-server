...
public class Sms {
     ...
     * @param maxLength
     */
    public Sms(Integer cleansedCode, String countryCode, Integer maxLength, Integer minLength, String phoneNumber) {
        super();
    ...
    public String toString() {
        ...
        sb.append(Sms.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
